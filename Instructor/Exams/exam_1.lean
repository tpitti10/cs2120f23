...
| (Expr.top_exp e), i => (eval_expr e i)
| (Expr.bottom_exp e), i => (eval_expr e i)
...
|(returnb, returnc) => fun (Sum.inl a, Sum.inr b)
...
|mk (bread : Bread) (filling : Sum Cheese Spread)
...
- add top_x and bottom_x as constructors in Expr
...
-- Answer: {X is true} is a model of (X ⇒ ⊥)
-/
